...
<html>
	...
	<body>
		...
		<div class="container">
            ...
            <form method="get" action="filtered_user_data.php">
        ...
        <div class="row">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    $sql = 'SELECT livedata.reg_no, student_information.name, student_information.department, student_information.year, livedata.in_time
                            FROM livedata
                            LEFT JOIN student_information ON livedata.reg_no = student_information.reg_no';
