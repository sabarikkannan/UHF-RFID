...
<html>
	...
	<body>
		...
		<ul class="topnav">
			...
			<li><a class="active" href="user_data.php">Attendance Data</a></li>
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    $sql = 'SELECT livedata.reg_no, student_information.name, student_information.department, student_information.year, livedata.in_time , outtime.out_time
                			...
                			LEFT JOIN outtime ON student_information.reg_no = outtime.reg_no'; // Corrected JOIN syntax and alias
